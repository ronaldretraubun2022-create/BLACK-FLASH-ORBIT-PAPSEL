          ...
          {liveBriefItems.map((brief, index) => (
            <article
              ...
              <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2">
                ...
                <div className="inline-flex min-w-0 flex-wrap items-center gap-x-2 gap-y-1">
                  ...
                  <time
                    className="whitespace-nowrap text-[11px] font-semibold tabular-nums text-zinc-500"
                    dateTime={brief.rawTime || undefined}
                  >
