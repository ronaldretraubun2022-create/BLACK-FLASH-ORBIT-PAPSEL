    ...
    },
    {
      ...
      tone:
        ["ready", "configured"].includes(
          dependencies?.workflowPersistence?.status,
        )
          ? "text-emerald-300"
          : "text-amber-200",
    },
...
function buildReadinessChecks(dashboardData, isTelemetryConnected) {
  ...
  return [
    ...
    },
    {
      ...
      ready: ["ready", "configured"].includes(
        dependencies?.workflowPersistence?.status,
      ),
    },
  ];
...
const moduleHealthItems = [
  {
    name: "Auth Layer",
    status: "Protected",
    detail: "route protection and session checks enabled",
  },
  {
    name: "Newsroom Engine",
    status: "Available",
    detail: "editorial routes and telemetry integration present",
  },
  {
    name: "Web Builder",
    status: "Available",
    detail: "preview, export, ZIP, and publish route preserved",
  },
  {
    name: "Security Center",
    status: "Enabled",
    detail: "runtime security controls exposed by backend telemetry",
  },
];
